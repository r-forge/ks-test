...
and transformed data $y$ and $z$, respectively.
...
test statistic in the discrete case depends on the underlying
...
\cite{Mdufour2001} explored goodness-of-fit tests for
...
extended study of \cite{dewev1973}.  Our \code{cvm.test()} function
also provides general one-sample
Cram\'{e}r-von Mises testing for continuous distributions simply
to help complement the functionality provided by other
