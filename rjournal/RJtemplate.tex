...
in the R language for two of the most popular nonparametric tests. 
This paper describes the the structure of these contributions and
...
in the small sample setting. The functions \pkg{ks.test} and \pkg{cvm.test} presented here serve to fill this void for users
